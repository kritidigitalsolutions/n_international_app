          ...
          Obx(() {
            switch (controller.termsConditions.value.status) {
              ...
              case Status.error:
                return Center(
                  child: Text(
                    controller.termsConditions.value.message ?? "Error",
                    style: const TextStyle(color: AppColors.white),
                  ),
                );
              case Status.completed:
                final data = controller.termsConditions.value.data?.legal;
                if (data == null || data.sections == null) {
                  return const Center(
                    child: Text("No terms and conditions data found", style: TextStyle(color: AppColors.white)),
                  );
                }
